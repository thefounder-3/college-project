...
Public Class Form3
    ...
    Dim sSQL = "SELECT * from BOOKISSUE"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        strinsert = "insert into BOOKISSUE values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & TextBox7.Text & "')"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim sql As String = "delete from BOOKISSUE where STUDENTSMARTCARDNO =  " & TextBox1.Text & " "
