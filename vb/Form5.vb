...
Public Class Form5
    ...
    Dim sSQL = "SELECT * from BOOKRETURN"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        strinsert = "insert into BOOKRETURN values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & TextBox7.Text & "','" & TextBox8.Text & "')"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim sql As String = "delete from BOOKRETURN where STUDENTSMARTCARDNO =  " & TextBox1.Text & " "
    ...
    Private Sub NavigateRecords()
        ...
        TextBox7.Text = objDS.Tables("customer").Rows(inc).Item(6)
        TextBox8.Text = objDS.Tables("customer").Rows(inc).Item(7)
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        MaxRows = objDS.Tables("customer").Rows.Count
        Dim d As String
        d = InputBox("Enter STUDENT SMART CARD No...!")
